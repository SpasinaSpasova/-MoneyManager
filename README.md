...
Any change in two types of categories is visualized for all users. **When category is deleted all expenses and incomes does not deleted. But the statistics board visualized only expense and incomes by active categories**
